...
export interface Room {
  ...
  tagline: string;
  /** Page <title> for the room's detail page */
  metaTitle: string;
  /** Meta description for the room's detail page */
...
export const rooms: Room[] = [
  {
    ...
    metaTitle: 'Ponderosa Room | Holliday Lake House',
    metaDescription:
      'A restful first-floor room with a king bed and ensuite spa bath — one of five bedrooms included in the whole-house booking at Holliday Lake House.',
    description: [
  ...
  },
  {
    ...
    metaTitle: 'Meadow Room | Holliday Lake House',
    metaDescription:
      'An airy room framed by wildflower meadow views, with a queen bed plus a window sleeper for three — one of five bedrooms in the whole-house stay.',
    description: [
  ...
  },
  {
    ...
    metaTitle: 'Little Meadow Room | Holliday Lake House',
    metaDescription:
      'A cozy room for two, accessed through the adjoining Meadow room — part of the five-bedroom whole-house booking at Holliday Lake House.',
    description: [
  ...
  },
  {
    ...
    metaTitle: 'Hilltop Room | Holliday Lake House',
    metaDescription:
      'The highest room in the house, with the longest views over the land and lake, sleeping three — one of five bedrooms included in the whole-house stay.',
    description: [
  ...
  },
  {
    ...
    metaTitle: 'Lake Room | Holliday Lake House',
    metaDescription:
      'The room closest to the water, configurable with a king or two twin beds — one of five bedrooms in the whole-house booking at Holliday Lake House.',
    description: [
  ...
  },
  {
    ...
    metaTitle: 'Loft | Holliday Lake House',
    metaDescription:
      'An open loft nook under the open beams with a full bed, part of the shared common area — included in the whole-house booking for up to 22 guests.',
    description: [
